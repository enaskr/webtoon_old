			...
			<dd>
				<div class='group' style='padding:0px;'>
					<table style="line-height:1.5;border-color:#ffffff;" border=1 width="100%" cellspacing=0 cellpadding=0>
						...
						<tr style='background-color:#f8f8f8' height='50' align='center'><td>아이디</td><td><input style='border:none; line-height:48px; width:70%;' type='text' name='userid' onChange='canJoin=false;'><input style='border:none; line-height:48px; width:30%;' type='button' value='중복확인' onClick='chkUserID(this.form);'></td></tr>
						<tr style='background-color:#f8f8f8' height='50' align='center'><td>비밀번호</td><td><input style='border:none; line-height:48px; width:100%;' type='text'name='userpassword'></td></tr>
						<tr style='background-color:#f8f8f8' height='50' align='center'><td>성명</td><td><input style='border:none; line-height:48px; width:100%;' type='text'name='username'></td></tr>
						<tr style='background-color:#f8f8f8' height='50' align='center'><td>이메일</td><td><input style='border:none; line-height:48px; width:100%;' type='text' name='useremail'></td></tr>
						...
						<tr style='background-color:#f8f8f8' height='50' align='center'><td>메모</td><td><input style='border:none; line-height:48px; width:100%;' type='text' name='usermemo'></td></tr>
